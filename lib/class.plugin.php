...
require_once ( SPOSTS_LIB . '/plugins.php' );
...
abstract class spostsPlugin
{
	...
	final private function loadPluginData() {
		if ( empty($this->p_data) ) {
			...
			$r_data = sposts_plugin_readme_data($this->p_file);
	...
	final private function isStandardSidebar() {
		...
		if (    class_exists('WP_Widget') &&
		        function_exists('register_widget') &&
				function_exists('unregister_widget') )
		{
			return true;
		} else {
